	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
				    <a href="${pageContext.request.contextPath }/student/subjectList.action" >
				      <i class="fa fa-edit fa-fw"></i> Graduation project topic selection 
				    </a>
				</li>
				<li>
				    <a href="${pageContext.request.contextPath }/student/studentChooseManangelist.action" class="active">
				      <i class="fa fa-dashboard fa-fw" ></i> subject management
				    </a>
				</li>
			</ul>
		</div>
						...
						<tbody>
							<c:forEach items="${page.rows}" var="row">
								<tr>
									...
									<td><a href="#" class="btn btn-primary btn-xs"  data-toggle="modal" data-target="#newTeacherDialog"onclick= "teacherInfor(${row.chooseid})">${row.teachername}</a></td>
									<td>${row.subjectname}</td>
									<td>${row.ischoose}</td>
									<td>
										<%-- <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick= "editSubject(${row.chooseid})">edit</a> --%>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_customer_form" 
					...
					<div class="form-group">
						<label for="new_phone" class="col-sm-2 control-label">telephone</label>
						<div class="col-sm-10">
						...
						<div class="form-group">
						<label for="new_phone" class="col-sm-2 control-label">teacher id</label>
						<div class="col-sm-10">
...
//清空新建客户窗口中的数据
	...
	function teacherInfor(id) {
		$.ajax({
	        type:"post",
	        url:"<%=basePath%>student/getTeacherInfoByChooseId.action",
	        data:{"id":id},
	...
	$.post("<%=basePath%>student/deleteChoose.action",{"id":id},
	function(data){
	            if(data =="OK"){
	                alert("success！");
	                window.location.reload();
